...
class Table:
    ...
    def make_grid(self):
        ...
        for pixel_nr in range(settings.width):
            ...
            self.grid_table.append([pixel_nr, round(total_time, 4), metro, line_time])
            # self.grid_table.append([pixel_nr, total_time, metro, line_time])
    ...
    def check_grid_table(self, clock):
        ...
        while True:
            try:
                ...
                elif self.grid_table[0][1] > clock:
                    break
            except IndexError:
                grid_finished = True
                break
    ...
    def make_bar(self, channel, pitch, note_time):
        ...
        try:
            ...
            # When a note is on, start drawing from the right border of the screen
                ...
                # )
                #
                if self.check_vert_times(note_time):
                    color = "green"
                else:
                    color = "brown"
