...
#
# alt_transition_R = ["E5", "G5", "C6", "E6", "C6", "B5", "C6", "G5"]
# alt_transition_L = ["E4", "G4", "C5", "E5", "C5", "B4", "C5", "G4"]
#
# alt_transition_fingering_R = [1, 2, 4, 5, 4, 3, 4, 2]
# alt_transition_fingering_L = [5, 4, 2, 1, 2, 3, 2, 4]
#
